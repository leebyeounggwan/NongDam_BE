...
public interface WorkLogRepository extends JpaRepository<WorkLog, Long> {
    ...
    public List<Object[]> selectHarvest(@Param("memberId") int memberId, @Param("cropId") int cropId,@Param("startDate")LocalDate startDate,@Param("endDate")LocalDate endDate);
